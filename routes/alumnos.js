...
router.get('/consulta1', function(req, res, next) {
...
router.get('/consulta2', function(req, res, next) {
...
router.get('/consulta3', function(req, res, next) {
  var hola = {
    cod_postal:req.body.cod_postal,
    grupo_sang_alumno:req.body.grupo_sang_alumno
  };
  bd.query("select * from alumnos where cod_postal='7601' and grupo_sang_alumno='RH-'",hola, function(error,filas){
        if (error) {
            console.log('error en el listado');
            return;
        }
...
router.get('/consulta4', function(req, res, next) {
  bd.query('select leg_alumno,apyn_alumno,dom_alumno,cod_postal,fecha_nac_alumno,email_alumno,grupo_sang_alumno,tel_fijo_alumno,tel_movil_alumno,dni_alumno from alumnos order by dni_alumno asc',req.body.dni_alumno, function(error,filas){
        if (error) {
            console.log('error en el listado');
            return;
        }
...
router.get('/consulta5', function(req, res, next) {
  bd.query("select leg_alumno,apyn_alumno,dom_alumno,cod_postal,fecha_nac_alumno,email_alumno,grupo_sang_alumno,tel_fijo_alumno,tel_movil_alumno,dni_alumno from alumnos where dom_alumno='Av. J.B. Justo'",req.body.dom_alumno, function(error,filas){
        if (error) {
            console.log('error en el listado');
            return;
        }
